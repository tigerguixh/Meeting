...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    private CharSequence btn_left_txt,btn_right_txt;
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        mTitleView = (TextView) mBarView.findViewById(R.id.actionbar_title_txt);
        mActionsView = (LinearLayout) mBarView.findViewById(R.id.actionbar_actions);
        
        mProgress = (ProgressBar) mBarView.findViewById(R.id.actionbar_progress);

        mBtnLeft=(TextView)findViewById(R.id.actionbar_home_txt);
    ...
    public void setBtnText(String lefttxt,String righttxt){
    	this.btn_left_txt=lefttxt;
    	this.btn_right_txt=righttxt;
    }
    ...
    private View inflateAction(Action action) {
        ...
        mBtnRight=(TextView)view.findViewById(R.id.btn_right_txt);
        mBtnRight.setText(btn_right_txt);
